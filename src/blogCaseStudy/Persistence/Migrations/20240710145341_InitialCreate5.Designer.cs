...
namespace Persistence.Migrations
{
    ...
    [Migration("20240710145341_InitialCreate5")]
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ed7205d1-da02-49fa-b870-fc7df9688498"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "ege@ege.com",
                            PasswordHash = new byte[] { 38, 27, 216, 136, 182, 28, 117, 1, 48, 214, 66, 62, 146, 94, 91, 237, 49, 206, 111, 93, 229, 241, 196, 14, 65, 75, 52, 16, 145, 131, 9, 142, 207, 130, 251, 85, 205, 44, 237, 141, 220, 106, 87, 178, 123, 113, 113, 172, 39, 176, 179, 100, 246, 247, 15, 26, 216, 118, 10, 148, 143, 2, 132, 52 },
                            PasswordSalt = new byte[] { 65, 1, 225, 34, 246, 127, 165, 209, 222, 43, 113, 9, 161, 187, 88, 126, 43, 239, 95, 5, 91, 98, 113, 38, 168, 144, 192, 232, 36, 44, 156, 67, 178, 154, 67, 31, 61, 24, 224, 5, 94, 220, 120, 140, 204, 81, 122, 227, 51, 78, 51, 14, 32, 134, 246, 40, 233, 137, 199, 181, 229, 191, 32, 113, 14, 119, 32, 55, 74, 213, 97, 235, 165, 159, 164, 80, 211, 131, 0, 237, 107, 73, 22, 35, 33, 242, 146, 33, 134, 177, 168, 169, 240, 148, 159, 4, 213, 56, 18, 102, 127, 110, 84, 19, 93, 53, 249, 105, 123, 39, 47, 229, 231, 59, 102, 80, 209, 102, 72, 78, 131, 99, 54, 110, 221, 163, 96, 35 },
                            UserName = "EgeUmut"
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9b29474f-44cc-4f7c-9b4f-bcbb6af6425c"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("ed7205d1-da02-49fa-b870-fc7df9688498")
                        });
                });
